 ...
 * if it's an old device that's still trying to use SSLv3. Use [.getStatus] to get the most recent status.
 * 
 * 
...
internal object SecurityProvider {
    private val TAG: String = SecurityProvider::class.java.simpleName
    ...
    internal enum class Status {
        UNCHECKED, UP_TO_DATE, PLAY_SERVICES_UPDATE_REQUIRED, PLAY_SERVICES_ERROR
    }
}